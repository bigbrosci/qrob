...
A Flask-based interface for interactively generating VASP INCAR files with the
QROB workflow.
...
Ensure the `brain` folder is in the parent directory of the `incar_gui` folder.
