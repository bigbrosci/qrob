# 🚀 Quick Start Guide - INCAR GUI

## 30-Second Setup

### Option 1: Direct Run (Recommended)
```bash
cd /home/qli/Dropbox/bin/qrob/incar_gui
pip install flask
python3 app.py
```
...
### Change Styling
Edit `/home/qli/Dropbox/bin/qrob/incar_gui/static/css/style.css`

### Modify Layout
Edit `/home/qli/Dropbox/bin/qrob/incar_gui/templates/index.html`
