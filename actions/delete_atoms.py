...
import sys
import os
# Ensure project root is on sys.path so `brain` package can be imported both
# when running the script from the repo root and when executing via absolute
# path (e.g. `python3 /full/path/actions/delete_atoms.py`).
