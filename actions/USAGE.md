...
This document explains how to use the two helper scripts in `actions/` that operate on VASP POSCAR files. Both scripts rely on ASE (Atomic Simulation Environment) being available in your Python environment.
