...
Your geo_gui.py viewer now has **fully functional atom selection** with visual atom labeling!
...
| File | Changes |
|------|---------|
| `qrob/geo_gui/geo_gui.py` | Enhanced labels, added guidance, improved translate |
