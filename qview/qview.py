...
# -*- coding: utf-8 -*-
"""
QVIEW: POSCAR Viewer and Editor for VASP calculations with p4vasp-like features.
...
def run_streamlit_app():
    ...
    st.set_page_config(page_title="QVIEW - VASP Structure Analyzer", layout="wide", initial_sidebar_state="collapsed")
    st.title("🔬 QVIEW")
