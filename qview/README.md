# QVIEW - Interactive 3D Molecular Structure Viewer

A professional-grade interactive 3D molecular structure viewer built with Streamlit and py3Dmol.
...
```
qrob/qview/
├── qview.py                    # Main application (1047 lines)
├── README.md                   # This file
└── docs/                       # Documentation
    ├── QUICKSTART.md
    ├── START_HERE.md
...
Quick entry points:
- **New to qview?** → `docs/QUICKSTART.md`
